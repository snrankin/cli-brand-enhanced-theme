...
function flex_row_shortcode( $atts , $content = null ) {
  ...
  return '<div class="flex-row flex-position-' . esc_attr($a['position']) . ' ' . esc_attr($a['wrap']) .  'wrap flex-align-' . esc_attr($a['align']) . ' ' . esc_attr($a['class']) . '">' . do_shortcode($content) . '</div>';
